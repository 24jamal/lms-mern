...
const CourseDetails = () => {
    ...
    useEffect(() => {
        if (userData && courseData) {
            setIsAlreadyEnrolled(userData.enrollCourses?.includes(courseData._id) || false)
        }
    }, [userData, courseData])
    ...
    return courseData ? (
        <>
            ...
            justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                ...
                md:rounded-none overflow-hidden bg-white max-w-md w-full'>
                    {
                    ...
                    <div className='p-5'>
                        <div className="flex items-center gap-2">
                            ...
                            <p>
                                <span className='font-medium'>5 days left</span>left at this price
                            </p>
                        </div>
