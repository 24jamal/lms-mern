...
const CallToAction = () => {
    return (
        <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
            ...
            <p className='text-gray-500 sm:text-sm:text-sm'>
                Join our community of learners and start your journey towards mastering new skills and achieving your goals with us.
            </p>
